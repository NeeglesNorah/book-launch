    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col sm:grid sm:grid-cols-2 lg:grid  lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <div className="h-full rounded-md lg:aspect-square p-6 flex justify-between flex-col" style={{ backgroundColor: '#fff' }}>
            <div className="w-8 h-8">
          ...
          <div className="bg-[#314E34] h-full rounded-md lg:aspect-square p-6 flex justify-between flex-col">
            <div className="w-8 h-8">
          ...
          <div className="h-full rounded-md lg:aspect-square p-6 flex justify-between flex-col" style={{ backgroundColor: '#314E34' }}>
            <div className="w-8 h-8">
              <svg fill="none" stroke="white" viewBox="0 0 24 24" className="w-full h-full">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
          ...
          <div className="bg-white h-full rounded-md lg:aspect-square p-6 flex justify-between flex-col">
            <div className="w-8 h-8">
              <svg fill="none" stroke="#314E34" viewBox="0 0 24 24" className="w-full h-full">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
